...
from coralquant.models.odl_model import TS_Daily_Basic, TS_TradeCal
...
def update_task():
    ...
    with session_scope() as sm:
        ...
        query = sm.query(cte1.c.date).join(cte2, cte1.c.date == cte2.c.trade_date, isouter=True).filter(
        ...
        for c in trade_dates:
            tasktable = TaskTable(task=TaskEnum.TS更新每日指标.value,

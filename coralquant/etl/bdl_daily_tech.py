...
from coralquant.models.bdl_model import DailyKData1, DailyKTech
...
def update_daily_tech_data(taskEnum: TaskEnum):
    ...
    with session_scope() as sm:
        ...
        for task in tqdm(rp):
            ...
            df.to_sql(DailyKTech.__tablename__, engine, schema=CQ_Config.DB_SCHEMA, if_exists="replace", index=False)
